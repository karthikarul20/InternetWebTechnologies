...
function list_categories ()
{
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<li class="odd"><a href="Search.php?query='. $category_name. '">';
        echo $category_name;
        echo '</a></li>';
    }
...
function list_popular_foods ()
{
    ...
    $result = mysqli_query($con,
            "select distinct(foodName) from nutrition_details limit 1,9");
    
    while ($row = mysqli_fetch_array($result)) {
        $category_name = $row['foodName'];
        debug_to_console("$category_name");
...
<div id="main_container">
		...
		<div id="header">
			<div id="logo">
				<a href="index.html"><img src="images/logo.gif" alt="" title=""	border="0" width="237" height="140" /></a>
			</div>
